...
SIM_TASK_CONFIGS = {
    ...
    'dvrk_ring': {
        'dataset_dir': DATA_DIR + '/ring_pickup20',
        'num_episodes': 20,
        'episode_len': 140,
        'camera_names': ['left','wrist_1'] 
    },
    'dvrk_retraction': {
        'dataset_dir': DATA_DIR + '/bilateral_smoke_no_f',
        'num_episodes': 20,
        'episode_len': 200,
        'camera_names': ['left','wrist_1'] 
    },
    'dvrk_retraction_u_nof': {
        'dataset_dir': DATA_DIR + '/normal_pin_f_AB',
        'num_episodes': 200,
        'episode_len': 200,
        'camera_names': ['left','wrist_1'] 
    }
...
### Simulation envs fixed constantss
DT = 0.02
