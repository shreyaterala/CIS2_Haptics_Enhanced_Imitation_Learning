...
from constants import DT, STATE_DIM
from constants import PUPPET_GRIPPER_JOINT_OPEN
from utils import load_data
from utils import sample_box_pose, sample_insertion_pose
from utils import compute_dict_mean, set_seed, detach_dict
from policy import ACTPolicy, CNNMLPPolicy
from data_validations.visualize_episodes import save_videos
...
def main(args):
    ...
    config = {
        ...
        'state_dim':       state_dim,
        'chunk_size':      args['chunk_size'],  # ← 新增，eval 阶段也需要
        'lr':              args['lr'],
    ...
    # ----------------------------------------------------------------
    # FIX: 传入 chunk_size，dataloader 输出 action shape = (B, chunk_size, state_dim)
    # ----------------------------------------------------------------
